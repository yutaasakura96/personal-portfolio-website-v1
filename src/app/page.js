    ...
    <main className="min-h-screen relative">
      ...
      >
        <div className='container m-auto'>
          <p className='text-[300px] text-[#f7fbfd] md:pl-[50px] px-5 max-w-[750px] w-[100%] overflow-hidden opacity-0'
          style={{transform:"translate(0px, -20px)"}}
          >portfolio</p>
          <div style={{transform:"translate(0px, -250px)"}}>
            <p className='text-[#48afde] md:pl-[80px] px-5 font-extrabold text-5xl'>Projects</p>
