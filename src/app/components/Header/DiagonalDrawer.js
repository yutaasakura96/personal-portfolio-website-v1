      ...
      {isOpen && (
        ...
        >
          <div className="relative">
            ...
            <div
              className="z-20 absolute transform-gpu ease-in-out duration-300
                  ...
                  <li className="group my-4 xl:my-4 2xl:my-6 relative">
                    <div className="inline-block relative">
                      <a
                        ...
                        className="focus:outline-none focus:ring focus:ring-[#48AFDE] rounded"
                      >
                        {t("home")}
                      </a>
                      {selectedIndex1 === 0 && (
                        <div className="absolute top-2 -left-2 w-full h-full transform-gpu transition-all duration-300 -rotate-6 opacity-100 bg-[#48AFDE] rounded-xl -z-10"></div>
                      )}
                    </div>
                  </li>
